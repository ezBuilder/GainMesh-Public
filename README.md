...
The disk-image entry is a link to the uninstaller inside the installed app, so it works once GainMesh is installed. You can also run it directly from `GainMesh.app/Contents/Resources/uninstall.command`.
